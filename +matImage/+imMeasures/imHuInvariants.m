...
cx = matImage.imMeasures.imMoment(img, 1, 0)/m00;
cy = matImage.imMeasures.imMoment(img, 0, 1)/m00;

% second-order centered and scaled moments
m02 = matImage.imMeasures.imCSMoment(img, 0, 2, [cx cy], m00);
m11 = matImage.imMeasures.imCSMoment(img, 1, 1, [cx cy], m00);
m20 = matImage.imMeasures.imCSMoment(img, 2, 0, [cx cy], m00);

% third-order centered and scaled moments
m30 = matImage.imMeasures.imCSMoment(img, 3, 0, [cx cy], m00);
m21 = matImage.imMeasures.imCSMoment(img, 2, 1, [cx cy], m00);
m12 = matImage.imMeasures.imCSMoment(img, 1, 2, [cx cy], m00);
m03 = matImage.imMeasures.imCSMoment(img, 0, 3, [cx cy], m00);

% fourth-order centered and scaled moments
m40 = matImage.imMeasures.imCSMoment(img, 4, 0, [cx cy], m00);
m31 = matImage.imMeasures.imCSMoment(img, 3, 1, [cx cy], m00);
m22 = matImage.imMeasures.imCSMoment(img, 2, 2, [cx cy], m00);
m13 = matImage.imMeasures.imCSMoment(img, 1, 3, [cx cy], m00);
m04 = matImage.imMeasures.imCSMoment(img, 0, 4, [cx cy], m00);
