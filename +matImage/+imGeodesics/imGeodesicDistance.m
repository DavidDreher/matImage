...
if ndims(mask) == 2 %#ok<ISMAT>
    for i = 1:N1
        dist = matImage.imGeodesics.imChamferDistance(mask, marker1==labels1(i), varargin{:});
    ...
    for i = 1:N1
        dist = matImage.imGeodesics.imChamferDistance3d(mask, marker1==labels1(i), varargin{:});
