...
if length(varargin)==1
    ...
    res = matImage.imFilters.imOverlay(img, varargin{1}, [1 0 0]);
    return;
...
elseif length(varargin)==3
    ...
    if ~isempty(varargin{1})
        res = matImage.imFilters.imOverlay(res, varargin{1}, [1 0 0]);
    end
    if ~isempty(varargin{2})
        res = matImage.imFilters.imOverlay(res, varargin{2}, [0 1 0]);
    end
    if ~isempty(varargin{3})
        res = matImage.imFilters.imOverlay(res, varargin{3}, [0 0 1]);
    end
    return;
end
