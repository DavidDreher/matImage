...
res(:,:,1) = matImage.imFilters.subsample(src(:,:,1), scale(1:2)');
res(:,:,2) = matImage.imFilters.subsample(src(:,:,2), scale(1:2)');
res(:,:,3) = matImage.imFilters.subsample(src(:,:,3), scale(1:2)');
