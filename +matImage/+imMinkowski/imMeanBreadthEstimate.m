...
if ~islogical(img)
    ...
    for i = 1:nLabels
        ...
        breadth(i) = matImage.imMinkowski.imMeanBreadthEstimate(bin, varargin{:});
    end
...
histo = matImage.imMinkowski.imBinaryConfigHisto(img);

lut = matImage.imMinkowski.imMeanBreadthLut(delta, nDirs);
