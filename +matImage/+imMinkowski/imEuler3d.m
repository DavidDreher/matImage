...
if ~islogical(img)
    ...
    for i=1:length(labels)
        chi(i) = matImage.imMinkowski.imEuler3d(img==labels(i), varargin{:});
    end
    return;
end
...
elseif conn == 26
    ...
    f10  = matImage.imMinkowski.imEuler2d(squeeze(img(1,:,:)), 8);
    f11  = matImage.imMinkowski.imEuler2d(squeeze(img(N1,:,:)), 8);
    f20  = matImage.imMinkowski.imEuler2d(squeeze(img(:,1,:)), 8);
    f21  = matImage.imMinkowski.imEuler2d(squeeze(img(:,N2,:)), 8);
    f30  = matImage.imMinkowski.imEuler2d(img(:,:,1), 8);
    f31  = matImage.imMinkowski.imEuler2d(img(:,:,N3), 8);
    ...
    e11 = matImage.imMinkowski.imEuler1d(img(:,1,1));
    e12 = matImage.imMinkowski.imEuler1d(img(:,1,N3));
    e13 = matImage.imMinkowski.imEuler1d(img(:,N2,1));
    e14 = matImage.imMinkowski.imEuler1d(img(:,N2,N3));
    
    e21 = matImage.imMinkowski.imEuler1d(img(1,:,1));
    e22 = matImage.imMinkowski.imEuler1d(img(1,:,N3));
    e23 = matImage.imMinkowski.imEuler1d(img(N1,:,1));
    e24 = matImage.imMinkowski.imEuler1d(img(N1,:,N3));
    
    e31 = matImage.imMinkowski.imEuler1d(img(1,1,:));
    e32 = matImage.imMinkowski.imEuler1d(img(1,N2,:));
    e33 = matImage.imMinkowski.imEuler1d(img(N1,1,:));
    e34 = matImage.imMinkowski.imEuler1d(img(N1,N2,:));
