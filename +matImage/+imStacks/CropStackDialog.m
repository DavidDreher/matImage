...
methods
    function onApplyButtonClicked(this, hObject, eventdata) %#ok<INUSD>
        ...
        if ~ishandle(this.parent.handles.figure)
            errordlg('matImage.imStacks.Slicer figure was closed', 'Crop Stack error', 'modal');
            close(this);
            return;
        end
        ...
        img2 = matImage.imStacks.cropStack(this.parent.imageData, box);
