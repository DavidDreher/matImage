...
methods
    ...
    function readImageStack(this, fileName)
        ...
        [img, map] = matImage.imStacks.readstack(fileName);
    ...
    function importMetaImage(this, fileName)
        ...
        % update display
        setupImageData(this, matImage.imStacks.metaImageRead(info), imgName);
    ...
    function importRawDataImage(this, fileName)
        ...
        img = matImage.imStacks.readstack(fileName, dataType, dims);
    ...
    function importVoxelMatrix(this, fileName)
        ...
        % read image data
        try
            data = matImage.imStacks.readVoxelMatrix(fileName, dataType);
        catch %#ok<CTCH>
...
methods
    ...
    function rotateImage(this, axis, n)
        ...
        [this.imageData, inds] = matImage.imStacks.rotateStack90(this.imageData, axis, n);
...
methods
    ...
    function onSaveImage(this, hObject, eventdata)
        ...
        switch (ext)
            case {'.mha', '.mhd'}
                matImage.imStacks.metaImageWrite(this.imageData, fullName);
                
            case {'.tif', '.tiff'}
                matImage.imStacks.savestack(this.imageData, fullName);
...
methods
    ...
    function onCropImage(this, hObject, eventdata)
        ...
        matImage.imStacks.CropStackDialog(this);
    end
    ...
    function onDisplayHistogram(this, varargin)
        ...
        hd = matImage.imStacks.SlicerHistogramDialog(img, 'useBackground', useBackground);
...
methods
    ...
    function onShowOrthoPlanes(this, varargin)
        ...
        ortholut = [];
        if ~matImage.imStacks.isColorStack(this.imageData) && ~isempty(this.colorMap)
            ortholut = this.colorMap;
        end
        
        % create figure with 3 orthogonal slices
        figure();
        matImage.imStacks.orthoSlices(this.imageData, pos, spacing, ...
    ...
    function onShowOrthoSlices3d(this, varargin)
        ...
        matImage.imStacks.OrthoSlicer3dOptionsDialog(this);
    end
    ...
    function onShowLabelIsosurfaces(this, varargin)
        ...
        matImage.imStacks.LabelIsosurfacesOptionsDialog(this);
    end
...
methods
    ...
    function updateSlice(this)
        ...
        if strcmp(this.imageType, 'vector')
            ...
            this.slice = matImage.imStacks.stackSlice(this.imageData, 3, index);
