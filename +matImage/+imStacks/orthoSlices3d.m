...
hold on;
hyz = matImage.imStacks.slice3d(img, 1, pos(1), spacing, options{:});
hxz = matImage.imStacks.slice3d(img, 2, pos(2), spacing, options{:});
hxy = matImage.imStacks.slice3d(img, 3, pos(3), spacing, options{:});
