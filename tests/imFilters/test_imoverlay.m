...
mask = createMask2d;
res = matImage.imFilters.imOverlay(img, mask);
...
% magenta overlay
res = matImage.imFilters.imOverlay(img, mask, [1 0 1]);
...
% magenta overlay
res = matImage.imFilters.imOverlay(img, mask, 'm');
...
% magenta overlay
res = matImage.imFilters.imOverlay(img, mask, ovr);
