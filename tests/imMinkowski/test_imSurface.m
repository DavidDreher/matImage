...
nDir = 3;
b = matImage.imMinkowski.imSurface(img, nDir);
bb = matImage.imMinkowski.imSurface(imgb, nDir);
assertEqual(b, bb);
...
nDir = 3;
b = matImage.imMinkowski.imSurface(img, nDir, [1 2 3]);
bb = matImage.imMinkowski.imSurface(imgb, nDir, [1 2 3]);
assertEqual(b, bb);
...
b3 = matImage.imMinkowski.imSurface(img, 3);
b13 = matImage.imMinkowski.imSurface(img, 13);
assertEqual(8, length(b3));
assertEqual(8, length(b13));

imgb = padarray(img, [1 1 1]);
bb3 = matImage.imMinkowski.imSurface(imgb, 3);
bb13 = matImage.imMinkowski.imSurface(imgb, 13);
