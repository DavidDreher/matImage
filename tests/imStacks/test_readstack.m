...
img = matImage.imStacks.readstack(fName);
...
fName = fullfile('ratBrainMriSlices', 'BRNOR39e5p1-000.tif');
img = matImage.imStacks.readstack(fName, 'verbose');
...
fName = fullfile('ratBrainMriSlices', 'BRNOR39e5p1-000.tif');
img = matImage.imStacks.readstack(fName, 'quiet');
...
fName = fullfile('ratBrainMriSlices', 'BRNOR39e5p1-000.tif');
range = 21:80;
img = matImage.imStacks.readstack(fName, range);
...
img = matImage.imStacks.readstack('img_10x15x20_int16.raw', [10 15 20], 'int16');
