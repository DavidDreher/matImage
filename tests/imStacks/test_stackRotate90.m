...
imgRX1 = matImage.imStacks.stackRotate90(img, 1, 1);
assertEqual(rotX1th, imgRX1);
imgRX1 = matImage.imStacks.stackRotate90(img, 'x', 1);
assertEqual(rotX1th, imgRX1);

rotX2th = cat(3, [7 8;5 6], [3 4;1 2]);
imgRX2 = matImage.imStacks.stackRotate90(img, 1, 2);
assertEqual(rotX2th, imgRX2);
imgRX2 = matImage.imStacks.stackRotate90(img, 'x', 2);
assertEqual(rotX2th, imgRX2);

rotX3th = cat(3, [3 4;7 8], [1 2;5 6]);
imgRX3 = matImage.imStacks.stackRotate90(img, 1, 3);
assertEqual(rotX3th, imgRX3);
imgRX3 = matImage.imStacks.stackRotate90(img, 'x', 3);
assertEqual(rotX3th, imgRX3);
...
imgRY1 = matImage.imStacks.stackRotate90(img, 2, 1);
assertEqual(rotY1th, imgRY1);
imgRY1 = matImage.imStacks.stackRotate90(img, 'y', 1);
assertEqual(rotY1th, imgRY1);

rotY2th = cat(3, [6 5;8 7], [2 1;4 3]);
imgRY2 = matImage.imStacks.stackRotate90(img, 2, 2);
assertEqual(rotY2th, imgRY2);
imgRY2 = matImage.imStacks.stackRotate90(img, 'y', 2);
assertEqual(rotY2th, imgRY2);

rotY3th = cat(3, [5 1;7 3], [6 2;8 4]);
imgRY3 = matImage.imStacks.stackRotate90(img, 2, 3);
assertEqual(rotY3th, imgRY3);
imgRY3 = matImage.imStacks.stackRotate90(img, 'y', 3);
assertEqual(rotY3th, imgRY3);
...
imgRZ1 = matImage.imStacks.stackRotate90(img, 3, 1);
assertEqual(rotZ1th, imgRZ1);
imgRZ1 = matImage.imStacks.stackRotate90(img, 'z', 1);
assertEqual(rotZ1th, imgRZ1);

rotZ2th = cat(3, [4 3;2 1], [8 7;6 5]);
imgRZ2 = matImage.imStacks.stackRotate90(img, 3, 2);
assertEqual(rotZ2th, imgRZ2);
imgRZ2 = matImage.imStacks.stackRotate90(img, 'z', 2);
assertEqual(rotZ2th, imgRZ2);

rotZ3th = cat(3, [2 4;1 3], [6 8;5 7]);
imgRZ3 = matImage.imStacks.stackRotate90(img, 3, 3);
assertEqual(rotZ3th, imgRZ3);
imgRZ3 = matImage.imStacks.stackRotate90(img, 'z', 3);
assertEqual(rotZ3th, imgRZ3);
...
img2 = matImage.imStacks.stackRotate90(img, 2, 1);
...
img2 = matImage.imStacks.stackRotate90(img, 1, 1);
...
img2 = matImage.imStacks.stackRotate90(img, 3, 1);
